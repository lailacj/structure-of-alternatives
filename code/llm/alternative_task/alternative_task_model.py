# Plan:
# Get a corpa of nouns. Add the query words from the experimental data into the corpa (if not already present).
# Get next word distribution from Qwen, on the nouns corpa, given a focus alternative contexts. 
# Sample an ordering. 
