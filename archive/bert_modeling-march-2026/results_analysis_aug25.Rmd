...
```{r}
# Import result files 
set_results = read_csv("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/results/set_results_cloze_prob_sep2025.csv",
                      col_types = cols(
...
ordering_results <- read_csv("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/results/ordering_results_cloze_prob_sep2025.csv",
                      col_types = cols(
                        context = col_character(),
                        trigger = col_character(),
                        query = col_character(),
...
conjunction_results <- read_csv("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/results/conjunction_results_cloze_prob_sep2025.csv",
                      col_types = cols(
                        context = col_character(),
                        trigger = col_character(),
                        query = col_character(),
...
disjunction_results <- read_csv("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/results/disjunction_results_cloze_prob_sep2025.csv",
                      col_types = cols(
                        context = col_character(),
                        trigger = col_character(),
                        query = col_character(),
...
always_negate_results = read_csv("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/results/always_negate_results_cloze_prob_sep2025.csv",
                      col_types = cols(
                        context = col_character(),
                        trigger = col_character(),
                        query = col_character(),
...
never_negate_results = read_csv("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/results/never_negate_results_cloze_prob_sep2025.csv",
                      col_types = cols(
                        context = col_character(),
                        trigger = col_character(),
                        query = col_character(),
...
p <- ggplot(summary_df, aes(x = model, y = mean_log_likelihood)) +
  ...
  ylim(-25, 5) +
  labs(
    title = "Mean Log Likelihood by Model (Average Everything)\nPseudo Cloze Probability",
    x = "Model",
    y = "Mean Log Likelihood"
  )

ggsave("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/figures/cloze_prob_mean_log_likelihood_by_model_average_everything.png", plot = p, width = 8, height = 6, dpi = 300)
...
ggsave("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/figures/cloze_probmean_log_likelihood_by_context.png", plot = p, width = 12, height = 6, dpi = 500)
...
ggsave("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/figures/cloze_prob_mean_log_likelihood_by_context.png", plot = p, width = 12, height = 6, dpi = 500)
...
keep <- c("tuna", "chips", "dressing", "cigarettes", "lettuce", "meat")

specific_context_df <- sca_data %>%
  filter(context == "salad",
  ...
  mutate(
    trigger_ord = reorder_within(cleaned_trigger,  trigger_relevance, within = "salad"),
    query_ord   = reorder_within(cleaned_query,   trigger_relevance,  within = "salad"),
    label = sprintf("%.2f\n(%.2f)", mean_neg, sd_neg)
  )
...
p = ggplot(specific_context_df, aes(x = trigger_ord, y = query_ord, fill = mean_neg)) +
  ...
  scale_y_reordered() +
  labs(
    title = "Salad — Average Human Negation",
...
ggsave("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/figures/cloze_prob_salad_human_negation.png", plot = p, width = 12, height = 6, dpi = 500)
...
p = ggplot(specific_context_df, aes(x = trigger_ord, y = query_ord, fill = mean_val)) +
  ...
  scale_y_reordered() +
  labs(
    title = "Salad - Average Negation Probability - Disjunction Model - Pseudo Cloze Prob",
    x = "Trigger (ordered by relevance)",
    y = "Query (ordered by relevance)"
  ) +
  coord_equal() +
...
ggsave("~/laila_johnston@brown.edu - Google Drive/Shared drives/BLT Lab/Current Studies/SCA (Structure of Computational Alternatives; formerly CompAlt and RSA)/Extensions (Laila)/figures/cloze_prob_salad_disjunction_negation.png", plot = p, width = 12, height = 6, dpi = 500)
