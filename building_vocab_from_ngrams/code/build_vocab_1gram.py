...
OUT_VOCAB = "/users/ljohnst7/data/ljohnst7/ngrams/vocab_1gram.txt"
OUT_COUNTS = "/users/ljohnst7/data/ljohnst7/ngrams/vocab_1gram_counts.tsv"
OUT_TARGET_COUNTS = "/users/ljohnst7/data/ljohnst7/ngrams/target_1gram_counts.tsv"
OUT_INFO = "/users/ljohnst7/data/ljohnst7/ngrams/vocab_1gram_info.json"
...
def main():
    ...
    if not gz_files:
        raise FileNotFoundError(f"No 1gram gz files found: {os.path.join(NGRAM_DIR, NGRAM_GLOB_PATTERN)}")
    ...
    # Write target counts from pass 1 in target-list order
    with open(OUT_TARGET_COUNTS, "w", encoding="utf-8") as out:
        for w in targets:
            out.write(f"{w}\t{target_counts[w]}\n")
    ...
    info = {
        ...
        "outputs": {
            ...
            "target_counts": OUT_TARGET_COUNTS,
            "info": OUT_INFO,
        },
    ...
    print(f"targets: {OUT_TARGET_COUNTS}")
